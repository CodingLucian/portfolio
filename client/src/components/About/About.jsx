  ...
  return (
    <div id='about' className={styles.container}>
      ...
      <div className={styles.row}>
        ...
        If you ask me what am I? There's no a simple and short answer. I have been an IT support guy, a video editor, a VFX artist, a team assistent for exchange studants. I did surveys, worked as hostel manager, became a dive master. I was also a farmer and a guitar player but mostly I would say, I'm traveling through life in my own way, just don't put a tag on me.
